...

{
  imports = [
    ...
    # Note: terminal removed to avoid conflict with kitty
    
    # Linux-specific modules
    ../../modules/linux/home/desktop/bare  # Bare Hyprland (no Noctalia)
    ../../modules/linux/home/terminal
  ];
  ...
  # Bare Hyprland with waybar, rofi, mako - no Noctalia
}